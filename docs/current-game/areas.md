...
| `fort_fancheng` | 樊城 / 北岸城防 fort | `20101-20120` | `rebuild addition` | 承接 `city_xiangyang` 北向大道，落成南關坡口、前柵、北岸關門、甕城軍道、校場與旗樓構成的北岸城防 fort。 |
| `city_xinye` | 新野 / 荊州內陸邊鎮 city | `20201-20220` | `rebuild addition` | 承接襄陽官署前街外路，落成東來牌門、義市十字、酒旗街、榜牆前街與義舍小院構成的荊州內陸邊鎮 city。 |
| `wild_xinye_fields` | 新野郊野 / 邊鎮外圍田野 wild | `20301-20320` | `rebuild addition` | 承接 `city_xinye` 西田路牌，落成田路出口、田埂岔路、灌渠木橋、村口茶棚與西野風碑構成的新野近郊 wild。 |
| `city_wan` | 宛 / 南北轉接歷史城市 | `20401-20420` | `rebuild addition` | 承接 `city_xinye` 北門路口，落成南門驛口、入城長街、宛城十字、驛舍前街與北門官道口構成的內陸轉接 city。 |
| `road_wan` | 往宛官道 / 洛宛南行 road | `20501-20520` | `rebuild addition` | 承接 `loyang` 津陽門與 `city_wan` 北門官道口，落成南驛口、官道中段、路亭與盤查坡口構成的南行官道 road。 |
...
| `district_loyang_east_market` | 洛陽東市 / 帝都商業 district | `21001-21020` | `rebuild addition` | 承接 `loyang` 的商街前帶，落成東市街口、東市主街、票據棚前、馬販角與差役榜口構成的洛陽商業 district。 |
...
- `fort_fancheng`：把襄陽北向大道正式接進樊城，透過南關坡口、前柵、北岸關門、甕城軍道、校場與旗樓把主線重新收束成北岸軍事 choke point。
- `city_xinye`：把襄陽官署前街外路正式接進新野，透過東來牌門、義市十字、酒旗街、榜牆前街與義舍小院把荊州北段重新展開成更偏地方人情的邊鎮 city。
- `wild_xinye_fields`：把新野西田路牌正式接進新野郊野，透過田路出口、田埂岔路、灌渠木橋、村口茶棚與西野風碑把邊鎮節奏重新鬆開成可辨位的近郊田野 wild。
- `city_wan`：把新野北門路口正式接進宛，透過南門驛口、入城長街、南市棚廊、宛城十字、驛舍前街與北門官道口把荊州北段重新收束成更有驛傳與榜牌秩序的歷史城市 hub。
- `road_wan`：把洛陽津陽門與宛北門官道口之間的抽象主線正式補成南行官道，透過南驛口、里程石、路亭與盤查坡口把帝都城門節奏一路轉接進宛道長路。
- `wild_wan_outer`：把宛西城牌樓正式接進城郊外帶，透過西城外道口、宛西郊道、茶棚前坪、田埂側路、路旁樹叢與流民營火把城內秩序重新鬆開成可辨位的近郊 wild。
- `district_chenliu_station`：把陳留南驛前院正式接進驛站分區，透過南驛街口、車馬棚道、旅票棚前、驛丞櫃口、行李長棚與旅舍前廊把城市旅行節奏真正細化成可停留的 district。
- `wild_chenliu_west`：把陳留西城門外牌樓正式接進西郊外帶，透過西門郊道口、陳西官道、茶亭前坪、柳溝田埂、樹叢側路與流民營灰地把城內秩序重新鬆開成中原城郊 wild。

...
- #Job 盤查過客
Rumor seeds:
- 有人提到 荊襄大道 最近似乎出現不尋常的動靜。
- 可預留一條支線通往地下、秘境或特殊遭遇區。

## World Links

- north: `city_xiangyang` (outgoing)
- south: `city_jiangxia` (outgoing)
...
```json
{
  ...
  "topology": {
    "clusters": [
      {
        "id": "road_jingxiang:junction",
        "label": "路口",
        "role": "junction"
      },
      {
        "id": "road_jingxiang:midway",
        "label": "中段區",
        "role": "midway"
      },
      {
        "id": "road_jingxiang:rest_stop",
        "label": "歇腳點",
        "role": "rest_stop"
      }
    ],
    "nodes": [
      {
        "id": "road_jingxiang.entry",
        "label": "入口節點",
        "cluster": "road_jingxiang:junction",
        "kind": "room_stub"
      },
      {
        "id": "road_jingxiang.core",
        "label": "核心節點",
        "cluster": "road_jingxiang:midway",
        "kind": "room_stub"
      },
      {
        "id": "road_jingxiang.service",
        "label": "服務 / 互動節點",
        "cluster": "road_jingxiang:rest_stop",
        "kind": "room_stub"
      },
      {
        "id": "road_jingxiang.link1",
        "label": "north 出口",
        "cluster": "road_jingxiang:junction",
        "kind": "world_link",
    ...
    "edges": [
      {
        "from": "road_jingxiang.entry",
        "to": "road_jingxiang.link1",
        "direction": "north",
        "type": "world_transition_stub"
      },
      {
        "from": "road_jingxiang.entry",
        "to": "road_jingxiang.link2",
        "direction": "south",
        "type": "world_transition_stub"
      },
      {
        "from": "road_jingxiang.entry",
        "to": "road_jingxiang.core",
        "direction": "forward",
        "type": "internal"
      },
      {
        "from": "road_jingxiang.core",
        "to": "road_jingxiang.service",
        "direction": "branch",
        "type": "internal"
      }
    ]

...
- #Job 採買
Rumor seeds:
- 有人提到 西涼 最近似乎出現不尋常的動靜。
- 可預留一條支線通往地下、秘境或特殊遭遇區。

## World Links

- east: `city_tianshui` (outgoing)
- east: `city_tianshui` (outgoing)
- north: `wild_xiliang_steppe` (outgoing)
- south: `wild_black_rock_hills` (outgoing)
...
```json
{
  ...
  "topology": {
    "clusters": [
      {
        "id": "city_xiliang:gate",
        "label": "城門入口",
        "role": "gate"
      },
      {
        "id": "city_xiliang:main_street",
        "label": "主街中心",
        "role": "main_street"
      },
      {
        "id": "city_xiliang:service_quarter",
        "label": "服務區",
        "role": "service_quarter"
      },
      {
        "id": "city_xiliang:branch_zone",
        "label": "支線區",
        "role": "branch_zone"
      }
    ],
    "nodes": [
      {
        "id": "city_xiliang.entry",
        "label": "入口節點",
        "cluster": "city_xiliang:gate",
        "kind": "room_stub"
      },
      {
        "id": "city_xiliang.core",
        "label": "核心節點",
        "cluster": "city_xiliang:main_street",
        "kind": "room_stub"
      },
      {
        "id": "city_xiliang.service",
        "label": "服務 / 互動節點",
        "cluster": "city_xiliang:service_quarter",
        "kind": "room_stub"
      },
      {
        "id": "city_xiliang.link1",
        "label": "east 出口",
        "cluster": "city_xiliang:gate",
        "kind": "world_link",
    ...
    "edges": [
      {
        "from": "city_xiliang.entry",
        "to": "city_xiliang.link1",
        "direction": "east",
        "type": "world_transition_stub"
      },
      {
        "from": "city_xiliang.entry",
        "to": "city_xiliang.link2",
        "direction": "east",
        "type": "world_transition_stub"
      },
      {
        "from": "city_xiliang.entry",
        "to": "city_xiliang.link3",
        "direction": "north",
        "type": "world_transition_stub"
      },
      {
        "from": "city_xiliang.entry",
        "to": "city_xiliang.link4",
        "direction": "south",
        "type": "world_transition_stub"
      },
      {
        "from": "city_xiliang.entry",
        "to": "city_xiliang.core",
        "direction": "forward",
        "type": "internal"
      },
      {
        "from": "city_xiliang.core",
        "to": "city_xiliang.service",
        "direction": "branch",
        "type": "internal"
      }
    ]

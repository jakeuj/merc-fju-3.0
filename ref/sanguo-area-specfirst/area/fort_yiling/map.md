...
- #Job 修補防線
Rumor seeds:
- 有人提到 夷陵 最近似乎出現不尋常的動靜。
- 深處可能藏有條件解鎖路線或事件房。

## World Links

- west: `fort_yongan` (outgoing)
- east: `city_jiangling` (outgoing)
...
```json
{
  ...
  "topology": {
    "clusters": [
      ...
      {
        "id": "fort_yiling:watch",
        "label": "望樓",
        "role": "watch"
      },
      {
        "id": "fort_yiling:secret_tunnel",
        "label": "密道",
        "role": "secret_tunnel"
      }
    ],
    "nodes": [
      {
        "id": "fort_yiling.entry",
        "label": "入口節點",
        "cluster": "fort_yiling:approach",
        "kind": "room_stub"
      },
      {
        "id": "fort_yiling.core",
        "label": "核心節點",
        "cluster": "fort_yiling:gate",
        "kind": "room_stub"
      },
      {
        "id": "fort_yiling.service",
        "label": "服務 / 互動節點",
        "cluster": "fort_yiling:camp",
        "kind": "room_stub"
      },
      {
        "id": "fort_yiling.link1",
        "label": "west 出口",
        "cluster": "fort_yiling:approach",
        "kind": "world_link",
      ...
      },
      {
        "id": "fort_yiling.deep",
        "label": "深處 / 支線節點",
        "cluster": "fort_yiling:secret_tunnel",
        "kind": "room_stub"
      }
    ],
    "edges": [
      {
        "from": "fort_yiling.entry",
        "to": "fort_yiling.link1",
        "direction": "west",
        "type": "world_transition_stub"
      },
      {
        "from": "fort_yiling.entry",
        "to": "fort_yiling.link2",
        "direction": "east",
        "type": "world_transition_stub"
      },
      {
      ...
      {
        "from": "fort_yiling.core",
        "to": "fort_yiling.service",
        "direction": "branch",
        "type": "internal"
      },
      {

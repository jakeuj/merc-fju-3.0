...
```json
{
  ...
  "topology": {
    "clusters": [
      {
        "id": "road_puyang:junction",
        "label": "路口",
        "role": "junction"
      },
      {
        "id": "road_puyang:midway",
        "label": "中段區",
        "role": "midway"
      },
      {
        "id": "road_puyang:rest_stop",
        "label": "歇腳點",
        "role": "rest_stop"
      }
    ],
    "nodes": [
      {
        "id": "road_puyang.entry",
        "label": "入口節點",
        "cluster": "road_puyang:junction",
        "kind": "room_stub"
      },
      {
        "id": "road_puyang.core",
        "label": "核心節點",
        "cluster": "road_puyang:midway",
        "kind": "room_stub"
      },
      {
        "id": "road_puyang.service",
        "label": "服務 / 互動節點",
        "cluster": "road_puyang:rest_stop",
        "kind": "room_stub"
      },
      {
        "id": "road_puyang.link1",
        "label": "south 出口",
        "cluster": "road_puyang:junction",
        "kind": "world_link",
    ...
    "edges": [
      {
        "from": "road_puyang.entry",
        "to": "road_puyang.link1",
        "direction": "south",
        "type": "world_transition_stub"
      },
      {
        "from": "road_puyang.entry",
        "to": "road_puyang.link2",
        "direction": "north",
        "type": "world_transition_stub"
      },
      {
      ...
      {
        "from": "road_puyang.core",
        "to": "road_puyang.service",
        "direction": "branch",
        "type": "internal"
      }
    ]

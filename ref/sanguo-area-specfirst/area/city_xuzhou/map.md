...
- #Job 採買
Rumor seeds:
- 有人提到 徐州 最近似乎出現不尋常的動靜。
- 可預留一條支線通往地下、秘境或特殊遭遇區。

## World Links

- west: `city_chenliu` (outgoing)
- south: `road_shouchun_xuzhou` (outgoing)
...
```json
{
  ...
  "topology": {
    "clusters": [
      ...
      {
        "id": "city_xuzhou:main_street",
        "label": "主街中心",
        "role": "main_street"
      },
      {
        "id": "city_xuzhou:service_quarter",
        "label": "服務區",
        "role": "service_quarter"
      },
      {
        "id": "city_xuzhou:branch_zone",
        "label": "支線區",
        "role": "branch_zone"
      }
    ],
    "nodes": [
      {
        "id": "city_xuzhou.entry",
        "label": "入口節點",
        "cluster": "city_xuzhou:gate",
        "kind": "room_stub"
      },
      {
        "id": "city_xuzhou.core",
        "label": "核心節點",
        "cluster": "city_xuzhou:main_street",
        "kind": "room_stub"
      },
      {
        "id": "city_xuzhou.service",
        "label": "服務 / 互動節點",
        "cluster": "city_xuzhou:service_quarter",
        "kind": "room_stub"
      },
      {
        "id": "city_xuzhou.link1",
        "label": "west 出口",
        "cluster": "city_xuzhou:gate",
        "kind": "world_link",
    ...
    "edges": [
      {
        "from": "city_xuzhou.entry",
        "to": "city_xuzhou.link1",
        "direction": "west",
        "type": "world_transition_stub"
      },
      {
        "from": "city_xuzhou.entry",
        "to": "city_xuzhou.link2",
        "direction": "south",
        "type": "world_transition_stub"
      },
      {
      ...
      {
        "from": "city_xuzhou.core",
        "to": "city_xuzhou.service",
        "direction": "branch",
        "type": "internal"
      }
    ]

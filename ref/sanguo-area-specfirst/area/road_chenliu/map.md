...
```json
{
  ...
  "topology": {
    "clusters": [
      {
        "id": "road_chenliu:junction",
        "label": "路口",
        "role": "junction"
      },
      {
        "id": "road_chenliu:midway",
        "label": "中段區",
        "role": "midway"
      },
      {
        "id": "road_chenliu:rest_stop",
        "label": "歇腳點",
        "role": "rest_stop"
      }
    ],
    "nodes": [
      {
        "id": "road_chenliu.entry",
        "label": "入口節點",
        "cluster": "road_chenliu:junction",
        "kind": "room_stub"
      },
      {
        "id": "road_chenliu.core",
        "label": "核心節點",
        "cluster": "road_chenliu:midway",
        "kind": "room_stub"
      },
      {
        "id": "road_chenliu.service",
        "label": "服務 / 互動節點",
        "cluster": "road_chenliu:rest_stop",
        "kind": "room_stub"
      },
      {
        "id": "road_chenliu.link1",
        "label": "west 出口",
        "cluster": "road_chenliu:junction",
        "kind": "world_link",
    ...
    "edges": [
      {
        "from": "road_chenliu.entry",
        "to": "road_chenliu.link1",
        "direction": "west",
        "type": "world_transition_stub"
      },
      {
        "from": "road_chenliu.entry",
        "to": "road_chenliu.link2",
        "direction": "east",
        "type": "world_transition_stub"
      },
      {
        "from": "road_chenliu.entry",
        "to": "road_chenliu.core",
        "direction": "forward",
        "type": "internal"
      },
      {
        "from": "road_chenliu.core",
        "to": "road_chenliu.service",
        "direction": "branch",
        "type": "internal"
      }
    ]

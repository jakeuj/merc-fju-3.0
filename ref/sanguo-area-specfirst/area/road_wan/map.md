...
- #Job 盤查過客
Rumor seeds:
- 有人提到 往宛官道 最近似乎出現不尋常的動靜。
- 可預留一條支線通往地下、秘境或特殊遭遇區。

## World Links

- north: `city_loyang` (outgoing)
- south: `city_wan` (outgoing)
    ...
    "nodes": [
      {
        "id": "road_wan.entry",
        "label": "入口節點",
        "cluster": "road_wan:junction",
        "kind": "room_stub"
      },
      {
        "id": "road_wan.core",
        "label": "核心節點",
        "cluster": "road_wan:midway",
        "kind": "room_stub"
      },
      {
        "id": "road_wan.service",
        "label": "服務 / 互動節點",
        "cluster": "road_wan:rest_stop",
        "kind": "room_stub"
      },
      {
        "id": "road_wan.link1",

...
- #Job 採買
Rumor seeds:
- 有人提到 新野 最近似乎出現不尋常的動靜。
- 可預留一條支線通往地下、秘境或特殊遭遇區。

## World Links

- north: `city_wan` (outgoing)
- east: `wild_xinye_fields` (outgoing)
...
```json
{
  ...
  "topology": {
    "clusters": [
      ...
      {
        "id": "city_xinye:main_street",
        "label": "主街中心",
        "role": "main_street"
      },
      {
        "id": "city_xinye:service_quarter",
        "label": "服務區",
        "role": "service_quarter"
      },
      {
        "id": "city_xinye:branch_zone",
        "label": "支線區",
        "role": "branch_zone"
      }
    ],
    "nodes": [
      {
        "id": "city_xinye.entry",
        "label": "入口節點",
        "cluster": "city_xinye:gate",
        "kind": "room_stub"
      },
      {
        "id": "city_xinye.core",
        "label": "核心節點",
        "cluster": "city_xinye:main_street",
        "kind": "room_stub"
      },
      {
        "id": "city_xinye.service",
        "label": "服務 / 互動節點",
        "cluster": "city_xinye:service_quarter",
        "kind": "room_stub"
      },
      {
        "id": "city_xinye.link1",
    ...
    "edges": [
      ...
      {
        "from": "city_xinye.core",
        "to": "city_xinye.service",
        "direction": "branch",
        "type": "internal"
      }
    ]

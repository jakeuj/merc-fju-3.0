...
`sec_rift_deeps` 承接 `sec_rift_core` 最深處的底層封界下方，把裂谷心核的「核心邊界」進一步推成真正的深層封印帶。這裡不再只是能感受到地脈脈動的底層核心，而是舊封印結構、裂界回音與被鎮住的異常存在同時留下痕跡的深層界域。
...
- Subtheme: `裂界 / 深層封印`
- LevelRange: `44-58`
- Parent area: `sec_rift_core`
- ReservedRoomBlock: `9701-9720`
- World gap filled: 把裂谷心核下方的深層封印 stub 轉成真正可規劃的裂界深層區，讓洛陽地下鏈在心核之後形成更明確的深層禁制節點

## Player Flow

1. 玩家從 `sec_rift_core/9612` 向下時，會先感受到原本規律的心核脈動被拉長成沉重回響，像整座裂界正在更深處緩慢應答。
...
- `up` from `9701`: planned link to `sec_rift_core` room `9612`
- `down` from `9712`: planned continuation to `裂界禁底 / 封印核心`
...
裂谷心核底層封界(9612)
   |
[9701] 界井落點 -- [9702] 回音石棧 -- [9703] 封印回廊 -- [9704] 裂律長橋 -- [9710] 墜界斷台
                                                     |                                  |
                                                  [9705] 界鳴內庭 -- [9706] 殘壇側室 -- [9707] 鎮鎖壁 -- [9708] 禁紋裂面 -- [9709] 觀界偏座
                                                                                         |
                                                                                       down
                                                                                         |
                                                                                      [9711] 井緣浮階
...
[9712] down -> future abyssal seal / deeper prison
```
...
```mapmd-json
{
  "area": {
    ...
    "name": "sec_rift_deeps",
    "title": "裂界深層",
    "design_notes": "第一版 spec-first 草案。先固定裂谷心核下方的深層封印主線、禁制支線與禁底界井入口。",
    "parent_area": "sec_rift_core",
    "level_range": "44-58",
    "planned_vnum_range": "9701-9720",
    ...
    "world_links": [
      {
        ...
        "target_room_vnum": 9612,
        "label": "底層封界"
      },
      {
        "direction": "down",
        "source_vnum": 9712,
        "target_area": "future_rift_abyss",
        "label": "禁底界井"
      }
    ],
    "clusters": [
  ...
  "rooms": [
    {
      ...
      "exits": [
        { "direction": "up", "to": 9612, "external": true },
        { "direction": "east", "to": 9702 }
      ],
      "enquires": ["退路", "封印"]
    },
    {
      ...
      "exits": [
        { "direction": "west", "to": 9701 },
        { "direction": "east", "to": 9703 }
      ]
    },
    {
      "vnum": 9703,
      ...
      "exits": [
        { "direction": "west", "to": 9702 },
        { "direction": "east", "to": 9704 },
        { "direction": "south", "to": 9705 }
      ],
      "keywords": [
        {
          "keyword": "封印紋",
    ...
    },
    {
      ...
      "labels": ["bridge", "seal"],
      "exits": [
        { "direction": "west", "to": 9703 },
        { "direction": "east", "to": 9710 }
      ],
      "enquires": ["鎮界", "下層"]
    },
    {
      ...
      "labels": ["core", "lore"],
      "exits": [
        { "direction": "north", "to": 9703 },
        { "direction": "east", "to": 9706 }
      ],
      "keywords": [
        {
          "keyword": "石盤",
    ...
    },
    {
      ...
      "exits": [
        { "direction": "west", "to": 9705 },
        { "direction": "east", "to": 9707 }
      ],
      "keywords": [
        {
          "keyword": "祭壇",
    ...
    },
    {
      ...
      "labels": ["seal", "risk"],
      "exits": [
        { "direction": "west", "to": 9706 },
        { "direction": "east", "to": 9708 }
      ],
      "keywords": [
        {
          "keyword": "鎖條",
    ...
    },
    {
      ...
      "exits": [
        { "direction": "west", "to": 9707 },
        { "direction": "east", "to": 9709 },
        { "direction": "down", "to": 9711 }
      ],
      "keywords": [
        {
          "keyword": "裂面",
    ...
    },
    {
      ...
      "labels": ["well", "depth"],
      "exits": [
        { "direction": "west", "to": 9704 },
        { "direction": "south", "to": 9711 }
      ],
      "enquires": ["界井", "下層"]
    },
    {
      ...
      "exits": [
        { "direction": "north", "to": 9710 },
        { "direction": "up", "to": 9708 },
        { "direction": "down", "to": 9712 }
      ],
      "enquires": ["界井", "退路"]
    },
    {

...
`sec_rift_abyss` 承接 `sec_rift_deeps` 最深處的底層封界下方，把裂谷心核的「核心邊界」進一步推成真正的深層封印帶。這裡不再只是能感受到地脈脈動的底層核心，而是舊封印結構、裂界回音與被鎮住的異常存在同時留下痕跡的深層界域。
...
- World gap filled: 把裂谷心核下方的深層封印 stub 轉成真正可規劃的裂界禁底區，讓洛陽地下鏈在心核之後形成更明確的深層禁制節點
...
- `down` from `9812`: planned continuation to `裂界禁底 / 封印核心`
...
[9812] down -> future abyssal seal / deeper prison
```

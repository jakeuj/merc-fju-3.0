...
`先完成 road_north_border 的 spec milestone：跑 map validate 與 generator --validate-only，通過後自動 commit；接著直接做 implementation milestone，正式把 city_xiangping/18309 接進北境邊道。`

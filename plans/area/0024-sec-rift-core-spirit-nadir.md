...
- `git commit -m "Add sec_rift_core_spirit_nadir area"`
  - committed as `1c77c8b`
...
`sec_rift_core_spirit_nadir` implementation milestone 已提交；下一步續做 `sec_rift_core_spirit_abyss` 的第一輪 runtime implementation。

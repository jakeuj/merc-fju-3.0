...
- `python -X utf8 .agents/skills/merc-area-builder/scripts/generate_roo_from_map_md.py area/wild_mountain_pass/map.md`
  - passed (`Wrote 9 room scaffold file(s) to area/wild_mountain_pass/roo`)
...
`先 commit 目前 wild_mountain_pass 的 implementation milestone；commit 後回到 queue 規則盤點下一個待建 area，建立下一個 spec milestone。`
